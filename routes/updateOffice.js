        ...
        handler: async(req, res)=>{
            ...
            if(arraytoPush && arraytoDelete){
                ...
                try{
                    ...
                    await OfficeModel.findByIdAndUpdate({_id:req.params.id},
                    ...
                    let result = await OfficeModel.findByIdAndUpdate({_id:req.params.id},{$pullAll: {photos: photoArrayRemove}}, {new : true});
